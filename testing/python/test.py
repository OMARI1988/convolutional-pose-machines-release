...
util.showBGRimage('1-original',img)
...
util.showBGRimage('2-scaled', imageToTest_padded, 'png')
...
util.showmap('3-torso',person_map * 256)
...
# print(x, y)
util.showmap('4-torso-scaled',person_map_resized * 256)
